...
// FaGift 아이콘 임시 정의 (react-icons에서 적절한 아이콘으로 대체하세요)
const FaGift = (props) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    ...
    {...props}
  >
    <path d="M19.5 10c-.2-.5-.5-1-1-1.4L12.9 3H8c-1.1 0-2 .9-2 2v2.83L2.28 10.4c-.45.9-.23 1.99.52 2.74.23.23.49.42.78.54.26.11.54.16.82.16h.56c.08 0 .15-.04.2-.09.21-.26.38-.56.49-.88.15-.42.23-.87.23-1.33 0-.54-.1-.04-.25-1.5-.1-.3-.15-.58-.15-.85 0-.25.04-.5.12-.75.08-.24.2-.47.38-.67.18-.2.39-.38.62-.52.23-.14.48-.25.75-.32.27-.07.55-.1.82-.1s.55.03.82.1c.27.07.52.18.75.32.23.14.44.32.62.52.18.2.3.43.38.67.08.25.12.5.12.75 0 .27-.05.55-.15.85-.1.3-.15.96-.25 1.5 0 .46.08.91.23 1.33.11.32.28.62.49.88.05.05.12.09.2.09h.56c.28 0 .56-.05.82-.16.29-.12.55-.31.78-.54.75-.75.97-1.84.52-2.74zM12 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM8 10c0 .98.21 1.88.55 2.7L12 16.29l3.45-3.58c.35-.83.55-1.73.55-2.71 0-2.03-1.05-3.77-2.58-4.83L12 4.16 10.58 5.17C9.05 6.23 8 7.97 8 10z" />
  </svg>
);
